...
const Head = () => {
  return (
    <Box display={"flex"} justifyContent={'space-between'} alignItems={'center'} className="bg-white px-10 py-6">
      <Grid display={"flex"} justifyContent={'center'} alignItems={'center'} item className="relative">
      ...
      <Grid display={'flex'} className="gap-5" alignItems={'center'} item>
